...
public class GenericWrathChangeParticle extends AbstractGameEffect implements CustomLighting {
    ...
    public void render(SpriteBatch sb) {
        if (!(this.delayTimer > 0.0F)) {
            ...
            sb.draw(this.img, this.x, this.y, (float)this.img.packedWidth / 2.0F, (float)this.img.packedHeight / 2.0F, (float)this.img.packedWidth, (float)this.img.packedHeight, this.scale * MathUtils.random(2.9F, 3.1F), this.scale * MathUtils.random(0.95F, 1.05F), this.rotation);
