...
public class AugmentPreviewCard extends AbstractCard {
    public static final String[] MY_TEXT = CardCrawlGame.languagePack.getUIString(ChimeraMonstersMod.makeID("AugmentPreviewCard")).TEXT;
    ...
    public AugmentPreviewCard(String name, String rawDescription) {
        super(ChimeraMonstersMod.makeID("PreviewCard"), name, "colorless/skill/insight", -2, rawDescription, CardType.SKILL, CardColor.COLORLESS, CardRarity.SPECIAL, CardTarget.NONE);
