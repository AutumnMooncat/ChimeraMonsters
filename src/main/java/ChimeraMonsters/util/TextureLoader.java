...
public class TextureLoader {
    ...
    public static Texture missingTexture = getTexture("ChimeraMonstersResources/images/ui/missing_texture.png");
     ...
     * @throws GdxRuntimeException - rip lol
     */
    private static void loadTexture(final String textureString) throws GdxRuntimeException {
        logger.info("Chimera Monsters | Loading Texture: {}", textureString);
