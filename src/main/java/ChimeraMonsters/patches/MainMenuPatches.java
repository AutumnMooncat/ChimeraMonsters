...
import ChimeraMonsters.screens.ModifierScreen;
...
public class MainMenuPatches {
    private static final UIStrings uiStrings = CardCrawlGame.languagePack.getUIString(ChimeraMonstersMod.makeID("MainMenu"));
    public static final String[] TEXT = uiStrings.TEXT;

    public static class Enums {
        @SpireEnum
        public static MenuButton.ClickResult MONSTER_MODIFIERS_BUTTON;
        @SpireEnum
        public static MainMenuScreen.CurScreen MONSTER_MODIFIERS_VIEW;
    }
    ...
    public static class ButtonAdderPatch {
        ...
        public static void setMainMenuButtons(MainMenuScreen __instance, @ByRef int[] index) {
            __instance.buttons.add(new MenuButton(Enums.MONSTER_MODIFIERS_BUTTON, index[0]));
            index[0]++;
        }
    ...
    public static class SetText {
        ...
        public static void setLobelText(MenuButton __instance, @ByRef String[] ___label) {
            if (__instance.result == Enums.MONSTER_MODIFIERS_BUTTON) {
                ___label[0] = TEXT[0];
            }
        }
    }
    ...
    public static class UpdateModifierScreen {
        ...
        public static void updateTime(MainMenuScreen __instance) {
            if (__instance.screen == Enums.MONSTER_MODIFIERS_VIEW) {
